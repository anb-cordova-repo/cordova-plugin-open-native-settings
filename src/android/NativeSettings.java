...
public class NativeSettings extends CordovaPlugin {
  ...
  public boolean execute(
    ...
    Uri packageUri = Uri.parse(
      "package:" + this.cordova.getActivity().getPackageName()
    );
    String result = "";
    ...
    if (action.equals("open")) {
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_ADD_ACCOUNT)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_APN_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_CAPTIONING_SETTINGS)
        );
    } else if (action.equals("cast")) {
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_CAST_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_DREAM_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_MEMORY_CARD_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_NFCSHARING_SETTINGS)
        );
    } else if (action.equals("nfc_payment")) {
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_NFC_PAYMENT_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_PRIVACY_SETTINGS)
        );
    } else if (action.equals("quick_launch")) {
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_QUICK_LAUNCH_SETTINGS)
        );
    } else if (action.equals("search")) {
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_SEARCH_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_SHOW_REGULATORY_INFO)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_USER_DICTIONARY_SETTINGS)
        );
      ...
      this.cordova.getActivity()
        .startActivity(
          new Intent(android.provider.Settings.ACTION_WIFI_IP_SETTINGS)
        );
